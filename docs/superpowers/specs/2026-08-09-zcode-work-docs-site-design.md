...
**/principles（AI-PRINCIPLES.md 精编）**：**8 条**原则卡片（勘误：源文档为八条）
1. 窄腰核心，能力在边缘
2. 记忆诚实而稳定
3. 规范先行，异议闭环
4. 量化胜过直觉
...
6. 人类保留最终否决权
7. 绝对理性：不盲从、不附和
8. 退场即重生：能力只许螺旋上升，不许骤降

每条：标题 + 核心要义（精编为 2-3 句）+ 页头冲突裁决顺序提示（AI-PRINCIPLES.md > AGENTS.md > skill > 默认行为）。尾部可选补「自我失效预案」一句概览。

**/decisions（DECISIONS.md 精编）**（勘误：共 D-001~D-004）：
- D-001：mem-recall.sh 去留 → 结论「保留降级试用」，复查点 2026-08-23
- D-002：每周「用不上就下」自检 → 并入周维护
- D-003：退场必带承接（螺旋收编）→ 周维护升级 deprecation-scan
- D-004：projects/ 项目约定 + project-scaffold 固化
